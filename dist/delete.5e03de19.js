...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../server/delete.js":[function(require,module,exports) {
...
document.addEventListener("click", function (e) {
  if (e.target && e.target.classList.contains("delete-button")) {
    ...
    var parentID = parentElement.getAttribute("data-id");
    var confirmDelete = confirm("Are you sure to delete ".concat(parentElement.querySelector(".character-name span").innerText, "?"));

    if (confirmDelete) {
      axios.delete("".concat(BASE_URL, "/").concat(parentID)).then(function (res) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../server/delete.js"], null)
//# sourceMappingURL=/delete.5e03de19.js.map